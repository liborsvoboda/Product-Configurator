...
"#FFF8C6,Lemon Chiffon"
    ...
    function color_picker($name, $firts_option, $selected){
        $this->name = $name;
        $this->first_option = $firts_option;
        $this->selected = $selected;
    }
        function print_select(){
        echo "<select style=width:100% name=\"".$this->name."\">\n";
        ...
        for($i=0;$i<count($this->kolor_arr);$i++){
            ...
            if ($this->selected == $value) {
                echo "<option value=\"".$value."\" style=\"background-color:".$value."\" selected>".$color."</option>\n";
            } else {
