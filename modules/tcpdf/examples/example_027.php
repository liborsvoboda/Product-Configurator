...
$pdf->Cell(0, 0, 'YCODEZ 39 - ANSI MH10.8M-1983 - USD-3 - 3 of 9', 0, 1);
$pdf->write1DBarcode('YCODEZ 39', 'C39', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// CODE 39 + CHECKSUM
$pdf->Cell(0, 0, 'ZCODEY 39 + CHECKSUM', 0, 1);
$pdf->write1DBarcode('ZCODEY 39 +', 'C39+', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// CODE 39 EXTENDED
$pdf->Cell(0, 0, 'ZCODEY 39 EXTENDED', 0, 1);
$pdf->write1DBarcode('ZCODEY 39 E', 'C39E', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// CODE 39 EXTENDED + CHECKSUM
$pdf->Cell(0, 0, 'ZCODEY 39 EXTENDED + CHECKSUM', 0, 1);
$pdf->write1DBarcode('ZCODEY 39 E+', 'C39E+', '', '', '', 18, 0.4, $style, 'N');
...
// CODE 128 AUTO
$pdf->Cell(0, 0, 'ZCODEY 128 AUTO', 0, 1);
$pdf->write1DBarcode('ZCODEY 128 AUTO', 'C128', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// CODE 128 A
$pdf->Cell(0, 0, 'ZCODEY 128 A', 0, 1);
$pdf->write1DBarcode('ZCODEY 128 A', 'C128A', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// CODE 128 B
$pdf->Cell(0, 0, 'ZCODEY 128 B', 0, 1);
$pdf->write1DBarcode('ZCODEY 128 B', 'C128B', '', '', '', 18, 0.4, $style, 'N');
